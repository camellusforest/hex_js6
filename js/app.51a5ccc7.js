(function (e) {
  function t(t) {
    for (
      var n, u, l = t[0], s = t[1], c = t[2], i = 0, v = [];
      i < l.length;
      i++
    )
      (u = l[i]),
  ...
  function u(e) {
    return (
      ...
      {
        about: "96c1c1ef",
        "chunk-2d224cc2": "4351c783",
        "chunk-2d2261a6": "939ca2e5",
      }[e] +
      ".js"
    );
  }
  ...
  "56d7": function (e, t, r) {
    ...
    var n = r("2b0e"),
          ...
          [
            r(
              ...
              [
                ...
                e._v(" | "),
                r("router-link", { attrs: { to: "/products" } }, [
                  e._v("products"),
                ]),
                e._v(" | "),
                r("router-link", { attrs: { to: "/question" } }, [
                  e._v("question"),
                ]),
                e._v(" | "),
              ],
      ...
      _ = d,
      b = (r("6c2b"), Object(u["a"])(_, f, h, !1, null, "7fbfaaea", null)),
      m = b.exports,
      g = { name: "Home", components: { HelloWorld: m } },
      k = g,
      j = Object(u["a"])(k, p, v, !1, null, null, null),
      w = j.exports;
    n["a"].use(i["a"]);
    var y = [
        ...
        },
        {
          path: "/products",
          component: function () {
            return r.e("chunk-2d2261a6").then(r.bind(null, "e6dc"));
          },
        },
        {
          path: "/question",
          component: function () {
            return r.e("chunk-2d224cc2").then(r.bind(null, "e254"));
          },
        },
      ],
      O = new i["a"]({ routes: y }),
...
//# sourceMappingURL=app.51a5ccc7.js.map
